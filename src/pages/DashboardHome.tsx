              ...
              <div className="xl:col-span-8 space-y-4">
                <article className="rounded-xl border border-border bg-card p-4">
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    {(tasks?.length ?? 0) === 0 && <p className="text-sm text-muted-foreground">No tasks assigned yet — new activity will appear here.</p>}
                  </div>
                </article>
              ...
              <div className="xl:col-span-4 space-y-4">
                ...
                <article className="rounded-xl border border-border bg-card p-4">
                  ...
                  <div className="mt-3 space-y-2">
                    ...
                    {(filteredCampaigns?.length ?? 0) === 0 && <p className="text-sm text-muted-foreground">No campaigns to display. Create one to get pipeline momentum.</p>}
                  </div>
                </article>
              </div>
            </section>
